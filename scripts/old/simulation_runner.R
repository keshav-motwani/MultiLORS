...
parameters = expand_parameters(considered_values, defaults, 50, c("MultiLORS", "glmnet", "ORC_L_MultiLORS", "ORC_L_glmnet", "ORC_ALL_MultiLORS", "ORC_ALL_glmnet", "ORC_L_ALL_MultiLORS", "ORC_L_ALL_glmnet"))[[ARRAY_ID]]
